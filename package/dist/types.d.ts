...
export type ResolvedModel<T extends ModelDefinition> = {
    [key in keyof T as T[key] extends OptionalField | UniqueField | DefaultField | PrimaryKeyField ? never : key]: ResolvedField<T[key]>;
} & {
    [key in keyof T as T[key] extends OptionalField | UniqueField | DefaultField | PrimaryKeyField ? key : never]?: ResolvedField<T[key]> | undefined;
};
...
export type ModelEventCallback<T extends ModelDefinition, U extends ModelEvent> = U extends "write" | "delete" ? NonCancellableModelEventCallback<T> : CancellableModelEventCallback<T>;
export {};
